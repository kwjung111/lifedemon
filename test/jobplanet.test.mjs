...
test("parses rating and employee count from a signed-in JobPlanet company card", () => {
  assert.deepEqual(parseJobPlanetCompanyCard("메가존클라우드(주)2.8IT/웹/통신∙서울8년차 (2018)2700명채용 중 88", "메가존클라우드(주)"), {
